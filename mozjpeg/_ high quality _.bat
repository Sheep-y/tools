...
echo | set /p print=.
%exe% -quality 92 "%input%" > "%~n1.q92.jpg"
echo | set /p print=.
%exe% -quality 94 "%input%" > "%~n1.q94.jpg"
echo | set /p print=.
%exe% -quality 96 "%input%" > "%~n1.q96.jpg"
echo | set /p print=.
%exe% -quality 98 "%input%" > "%~n1.q98.jpg"
echo | set /p print=.
%exe% -quality 100 "%input%" > "%~n1.q100.jpg"
